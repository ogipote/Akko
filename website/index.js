...
app.get('/topgg', (req, res) => res.redirect('https://top.gg/fr/bot/855107430693077033'));

app.get('/privacy', (req, res) => res.redirect('https://github.com/HordLawk/YottaBot/wiki/Privacy-Policy'));

app.get('*', (req, res) => res.redirect(`https://discord.com/api/oauth2/authorize?client_id=983162005009600512&permissions=${permissions}&scope=bot+applications.commands`));
